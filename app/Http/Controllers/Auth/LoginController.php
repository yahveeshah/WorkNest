...
class LoginController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Find the organization (case-insensitive)
        ...
        // Find the user to check if they belong to this organization
        ...
        if (!$user) {
            return back()->withErrors([
                'email' => 'These credentials do not match our records for this organization.'
            ])->withInput($request->only('organization_name', 'email'));
        }
